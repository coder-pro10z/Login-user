  ...
  return(
   <>
     <label  className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('Wifi')} name='Wifi' type="checkbox" onChange={handlecbClick}></input>
                ...
                <label className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('Free parking slot')} name='Free parking slot'  type="checkbox" onChange={handlecbClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <label className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('TV')} name='TV' type="checkbox" onChange={handlecbClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <label className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('Radio')} name='Radio' type="checkbox" onChange={handlecbClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3v3m3-3v3m-10.125-3h17.25c.621 0 1.125-.504 1.125-1.125V4.875c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125z" />
                </svg>
                <span> Radio</span>
                ...
                <label className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('Private Enterance')} name='Private Enterance' type="checkbox" onChange={handlecbClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <label className="border-2 flex rounded-xl gap-2 p-4 items-center cursor-pointer">
                <input checked={selected.includes('Pets')} name='Pets' type="checkbox" onChange={handlecbClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
