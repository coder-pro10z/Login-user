      ...
      <div className="shadow-lg font-no rounded-md m-7 p-5 flex flex-col items-center">
        ...
        <form className="flex flex-col items-center gap-3">
          ...
          <div className="flex gap-3">
            <button className="bg-primary rounded-md p-3" type="button" onClick={handleSaveClick}>
              Save
            </button>
            <button className="bg-gray-400 rounded-md p-3" type="button" onClick={handleCancelClick}>
              Cancel
            </button>
          </div>
        </form>
