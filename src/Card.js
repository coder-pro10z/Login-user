...
const Card = () => {
  ...
  return (
    <div className="shadow-lg font-no rounded-md m-[7%] border p-[16%] flex flex-col items-center bg-three">
      <div>
   ...
   lable
      ...
      <button className='flex gap-1 justify-center bg-three rounded-md p-3 align-middle' onClick={handleEditClick}>Edit  
